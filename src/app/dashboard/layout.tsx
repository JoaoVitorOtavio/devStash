...
import { getUserProfile, getEditorPreferences } from "@/server/db/user";
...
export default async function DashboardLayout({
  ...
  const [itemTypes, collections, recentCollections, searchItems, searchCollections, editorPreferences] = await Promise.all([
